...
@Component({
  selector: 'botbuster',
  templateUrl: './botbuster.component.html',
  styleUrls: ['./botbuster.component.scss']
})
export class BotbusterComponent implements OnInit {
@ViewChild('chatBody') chatBody!: ElementRef;
  ...
  private readonly idleTime = 500; // 1 min in milliseconds
